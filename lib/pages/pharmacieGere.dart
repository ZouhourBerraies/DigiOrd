...
import '../pages/listeOrdPharamcie.dart';
...
class _pharamcie_gereState extends State<pharamcie_gere> {
            ...
            child: new Stack(
              children: [
                ...
                Positioned(
                    left: 35,
                    top: 80,
                    child: new Text("Espace Pharamcie",style: TextStyle(fontSize:35.0,color: Colors.cyan.shade700,fontWeight: FontWeight.bold),))
              ],
            ),
          ),
